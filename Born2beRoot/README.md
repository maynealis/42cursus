...
2. Create a new VM using **Oracle VM Virtual Box**. 
TODO: put a picture of my choosing setup at the end. 
RAM : 1024MB and 1 processor. 10GB on the disk (allocated dynamicaly) and choose the ISO downloaded on the disk.

[!note] 
TODO: Why the amount of space chosen?
...
[Reference](https://www.techtarget.com/whatis/definition/server)
[Reference](https://www.masterdc.com/blog/what-is-virtual-machine-server-network/)
